 ...
 *       Ensure that the pixel pointer is valid and points to a properly initialized RGBTRIPLE structure.
 *
 ...
 * @return BYTE (uint8_t) representing the calculated threshold value clamped within the range [0, 255].
 *
