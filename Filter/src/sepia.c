...
{
    int sepia_blue = .272 * pixel->rgbtRed + .534 * pixel->rgbtGreen  + .131 * pixel->rgbtBlue;
    int sepia_green = .349 * pixel->rgbtRed + .686 * pixel->rgbtGreen + .168 * pixel->rgbtBlue;
    int sepia_red = .393 * pixel->rgbtRed + .769 * pixel->rgbtGreen + .189 * pixel->rgbtBlue;
